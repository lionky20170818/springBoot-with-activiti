package com.ligl.demo.c_exclusiveGateWay;
 ...
 */
public class ExclusiveGateWayTest extends OverFlowTest {
    @Autowired
    ...
    public void deploymentProcessDefinition_inputStream() {
        // 获取同包下面的文件
        InputStream inputStreamBpmn = this.getClass().getResourceAsStream("c_exclusiveGateWay.bpmn");
        InputStream inputStreamPng = this.getClass().getResourceAsStream("c_exclusiveGateWay.png");

        Deployment deployment = processEngine.getRepositoryService() // 与流程定义和部署对象相关的Service
                .createDeployment() // 创建一个部署对象
                .name("排他网关") // 添加部署的名称
                .addInputStream("c_exclusiveGateWay.bpmn", inputStreamBpmn) //
                .addInputStream("c_exclusiveGateWay.png", inputStreamPng) //
                .deploy(); // 完成部署
    ...
    public void startProcessInstance() {
        String processDefinitionKey = "c_exclusiveGateWay"; // 使用Key的启动，默认按照对心版本的流程定义启动
...
//							.deleteDeployment(deploymentId);
    ...
    public void completeMyPersonalTask() {
        ...
        //设置money
        variables.put("money", 200); // case1：800
        //a_variables.put("money", 800); // case1：800
        //a_variables.put("money", 800); // case1：800
