...
public class StartTest extends OverFlowTest {
    ...
    public void deploymentProcessDefinition_inputStream() {
        // 获取同包下面的文件
        InputStream inputStreamBpmn = this.getClass().getResourceAsStream("f_start.bpmn");
        InputStream inputStreamPng = this.getClass().getResourceAsStream("f_start.png");

        Deployment deployment = processEngine.getRepositoryService() // 与流程定义和部署对象相关的Service
                .createDeployment() // 创建一个部署对象
                .name("开始") // 添加部署的名称
                .addInputStream("f_start.bpmn", inputStreamBpmn) //
                .addInputStream("f_start.png", inputStreamPng) //
                .deploy(); // 完成部署
    ...
    public void startProcessInstance() {
        String processDefinitionKey = "f_start"; // 使用Key的启动，默认按照对心版本的流程定义启动
