...
ORYX.I18N.SyntaxChecker.BPMN_STARTEVENT_WITHOUT_OUTGOING_CONTROL_FLOW = "A f_start event must have an outgoing sequence flow.";
...
ORYX.I18N.SyntaxChecker.EPC_MANY_STARTS = "There must be only one f_start event.";
...
ORYX.I18N.SyntaxChecker.BPMN2_EVENT_BASED_NOT_INSTANTIATING = "The Gateway does not meet the conditions to instantiate the processes. Please use a f_start event or an instantiating attribute for the gateway.";
